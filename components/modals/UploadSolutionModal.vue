        ...
        <div class="p-4">
            ...
            <UTabs :items="tabs">
                ...
                <template v-slot:file_upload>
                    ...
                    <div class="my-4 p-3 transition linear delay-150 w-full h-56 flex items-center justify-center relative rounded-md border-2 hover:border-gray-700 border-gray-400 border-dashed">
                ...
                <template v-slot:github_url>
                    <Form class="my-4">
                        <UInput placeholder="Вставьте ссылку на Github репозиторий" />
                        <!-- <UButton @click="uploadFileToServer" trailing :disabled="!form.file" :loading="isTaskSolutionUploading" class="order-0 xs:order-1 w-full xs:w-auto py-3 btn btn--primary">
                            {{ uploadButtonLabel }}
                        </UButton> -->
                    </Form>
